...
import { ReglaNegocioError } from './biblioteca.service';

/** Mensajes breves al usuario y manejo uniforme de errores de negocio. */
...
export class NotificacionesService {
  ...
  /** Ejecuta una acción asíncrona mostrando éxito o error. Devuelve undefined si falló. */
